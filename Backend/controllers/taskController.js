...
const getTasks = async (req, res) => {
    try {
        ...
        //Add complated todochecklist count to each task
...
const createTask = async (req, res) => {
    try {
        const {
            ...
            attachments,
            todoChecklist,
        } = req.body; // Corrected from req.bosy to req.body
...
const getDashboardData = async (req, res) => {
    try {
        ...
        taskDistribution["All"] = totalTasks; //Add total count to taskDistributaion

        //Emsure all priority levels are includes
...
const getUserDashboardData = async (req, res) => {
    try {
        ...
        //Fetch recent 10 tasks for logged-n user
